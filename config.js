...
module.exports = {
    SESSION: process.env.BOBIZ_SESSION === undefined ? '' : process.env.MUSIC_SESSION,
    URL_1NAME: process.env.URL_1NAME === undefined ? '🎃Follow me on Instagram🎃' : process.env.URL_1NAME,
    URL_1LINK: process.env.URL_1LINK === undefined ? 'http://instagram.com/tgvnmusic' : process.env.URL_1LINK,
    ...
    FOOTER: process.env.FOOTER === undefined ? 'MUSIC BOT  instagram.com/tgvnmusic تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶 ＭＵＳＩＣ ＢＯＴ https://www.instagram.com/tgvnmusic  ' : process.env.CAPTION,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE 
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://images.app.goo.gl/t5eT81PtfeTXCxLj9' : process.env.ALIVE_LOGO,
