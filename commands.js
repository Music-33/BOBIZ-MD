...
const fs = require('fs');
const ownerNumber = ['212774339435']
const prefix = '.'
...
await conn.sendMessage(from , { text: 'error' }, { quoted: mek } )  
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
    ...
    const listMessage = {
      text: " \n\n name : " + q + '\n\n ',
      footer: config.FOOTER,
      title: '♬ ＭＵＳＩＣ ＢＯＴ ➹ تحميل التطبيقات',
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + `FN:` + 'MOHAMED LMAYSSE' + `\n` // full name
            + 'TEL;type=CELL;type=VOICE;waid=' + '212774339435' + ':+' + '212774339435' + '\n' // WhatsApp ID + phone number
            + 'END:VCARD'
 await conn.sendMessage(from,{ contacts: { displayName: 'MOHAMED LMAYSSE' , contacts: [{ vcard }]  }} , { quoted: mek })      
		      break 
 //_______________________________________________________________________________________________________________________________________________________   //		      
